...
class DataStore {
    ...
    func createDummyDimeMedia () {
        ...
        let dimeMedia4 = DimeMedia(photoURL: "t4", dateCreated: "OCT 8", likes: "4", likedBy: ["Oliver", "Joe"], caption: "It was the best Time")
        
        let firstDimeAlbum = DimeAlbum(media: [dimeMedia1, dimeMedia2, dimeMedia3, dimeMedia4], mainDimePhoto: dimeMedia3, dateCreated: "10.25.16", likes: "89", likedBy: ["Lisa, Alice, Jason"], caption: "First Dime album what do you guys think")
