...
class MediaTableViewCell: UITableViewCell {
    ...
    @IBAction func likeDidTap(){
        if media.likes.contains(currentUser) {
            likeButton.setImage(#imageLiteral(resourceName: "icon-like"), for: [])
            media.unlikedBy(user: currentUser)
        }else{
            likeButton.setImage(#imageLiteral(resourceName: "icon-like-filled"), for: [])
    ...
    @IBAction func viewAllCommentstDidTap(){
